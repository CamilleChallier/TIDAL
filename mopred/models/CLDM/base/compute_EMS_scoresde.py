"""
Utility to compute empirical model statistics (EMS) from a trained score model,
used to initialise DPM-Solver-v3's adaptive scheduling.
Based on score_sde (https://github.com/yang-song/score_sde_pytorch).
"""
