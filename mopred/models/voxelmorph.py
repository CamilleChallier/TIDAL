"""
VoxelMorph registration network (U-Net encoder-decoder with a DVF regression head).
Used as an alternative registration backbone and as a DVF-supervision teacher.
